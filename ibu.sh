...
#    root -l -b -q outhist_systematics.C\(\"${sys}\",${nominal_name},${iter_name},${pion_name},${smear_name},${sys_name},${cent_in}\)
...
#root -l trk_efficiency.C\(\"outhist_ru_2_3_${ncent}bin.root\",\"outhist_zr_2_3_${ncent}bin.root\",\"systematics_ru_2_3_${ncent}bin.root\",\"systematics_zr_2_3_${ncent}bin.root\",${cent_in}\)
