void raa_summary_16bin()
{
//=========Macro generated from canvas: compile_raa/
//=========  (Mon Sep 26 17:17:26 2022) by ROOT version 6.22/06
   TCanvas *compile_raa = new TCanvas("compile_raa", "",0,0,1000,800);
   gStyle->SetOptStat(0);
...
tex->SetNDC();
   ...
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","Graph",100,7.02765,188.1582);
   Graph_Graph01001->SetMinimum(0.3684524);
   Graph_Graph01001->SetMaximum(1.07729);
   ...
   TH1F *Graph_Graph11002 = new TH1F("Graph_Graph11002","Graph",100,6.39036,187.2887);
   Graph_Graph11002->SetMinimum(0.3650325);
   Graph_Graph11002->SetMaximum(1.088661);
   ...
   TH1F *Graph_Graph21003 = new TH1F("Graph_Graph21003","Graph",100,7.230942,182.7485);
   Graph_Graph21003->SetMinimum(0.3973724);
   Graph_Graph21003->SetMaximum(1.034839);
   ...
   0.02164197,
   0.02369887};
   gre = new TGraphErrors(16,Graph3_fx1004,Graph3_fy1004,Graph3_fex1004,Graph3_fey1004);
   gre->SetName("Graph3");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph31004 = new TH1F("Graph_Graph31004","Graph",100,6.563466,181.8894);
   Graph_Graph31004->SetMinimum(0.3938841);
   Graph_Graph31004->SetMaximum(1.046696);
...
tex->SetNDC();
   ...
   0.04523478,
   0.04189107};
   gre = new TGraphErrors(16,Graph0_fx1007,Graph0_fy1007,Graph0_fex1007,Graph0_fey1007);
   gre->SetName("Graph0");
   gre->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph010011007 = new TH1F("Graph_Graph_Graph010011007","Graph",100,7.02765,188.1582);
   Graph_Graph_Graph010011007->SetMinimum(0.3684524);
   Graph_Graph_Graph010011007->SetMaximum(1.07729);
   ...
   0.0460652,
   0.04043124};
   gre = new TGraphErrors(16,Graph1_fx1008,Graph1_fy1008,Graph1_fex1008,Graph1_fey1008);
   gre->SetName("Graph1");
   gre->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph110021008 = new TH1F("Graph_Graph_Graph110021008","Graph",100,6.39036,187.2887);
   Graph_Graph_Graph110021008->SetMinimum(0.3650325);
   Graph_Graph_Graph110021008->SetMaximum(1.088661);
   ...
   0.02275626,
   0.02599094};
   gre = new TGraphErrors(16,Graph2_fx1009,Graph2_fy1009,Graph2_fex1009,Graph2_fey1009);
   gre->SetName("Graph2");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph_Graph210031009 = new TH1F("Graph_Graph_Graph210031009","Graph",100,7.230942,182.7485);
   Graph_Graph_Graph210031009->SetMinimum(0.3973724);
   Graph_Graph_Graph210031009->SetMaximum(1.034839);
   ...
   0.02164197,
   0.02369887};
   gre = new TGraphErrors(16,Graph3_fx1010,Graph3_fy1010,Graph3_fex1010,Graph3_fey1010);
   gre->SetName("Graph3");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph_Graph310041010 = new TH1F("Graph_Graph_Graph310041010","Graph",100,6.563466,181.8894);
   Graph_Graph_Graph310041010->SetMinimum(0.3938841);
   Graph_Graph_Graph310041010->SetMaximum(1.046696);
...
tex->SetNDC();
   ...
   0.04523478,
   0.04189107};
   gre = new TGraphErrors(16,Graph0_fx1013,Graph0_fy1013,Graph0_fex1013,Graph0_fey1013);
   gre->SetName("Graph0");
   gre->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph0100110071013 = new TH1F("Graph_Graph_Graph_Graph0100110071013","Graph",100,7.02765,188.1582);
   Graph_Graph_Graph_Graph0100110071013->SetMinimum(0.3684524);
   Graph_Graph_Graph_Graph0100110071013->SetMaximum(1.07729);
   ...
   0.0460652,
   0.04043124};
   gre = new TGraphErrors(16,Graph1_fx1014,Graph1_fy1014,Graph1_fex1014,Graph1_fey1014);
   gre->SetName("Graph1");
   gre->SetTitle("Graph");
   ...
   TH1F *Graph_Graph_Graph_Graph1100210081014 = new TH1F("Graph_Graph_Graph_Graph1100210081014","Graph",100,6.39036,187.2887);
   Graph_Graph_Graph_Graph1100210081014->SetMinimum(0.3650325);
   Graph_Graph_Graph_Graph1100210081014->SetMaximum(1.088661);
   ...
   0.02275626,
   0.02599094};
   gre = new TGraphErrors(16,Graph2_fx1015,Graph2_fy1015,Graph2_fex1015,Graph2_fey1015);
   gre->SetName("Graph2");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph_Graph_Graph2100310091015 = new TH1F("Graph_Graph_Graph_Graph2100310091015","Graph",100,7.230942,182.7485);
   Graph_Graph_Graph_Graph2100310091015->SetMinimum(0.3973724);
   Graph_Graph_Graph_Graph2100310091015->SetMaximum(1.034839);
   ...
   0.02164197,
   0.02369887};
   gre = new TGraphErrors(16,Graph3_fx1016,Graph3_fy1016,Graph3_fex1016,Graph3_fey1016);
   gre->SetName("Graph3");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph_Graph_Graph3100410101016 = new TH1F("Graph_Graph_Graph_Graph3100410101016","Graph",100,6.563466,181.8894);
   Graph_Graph_Graph_Graph3100410101016->SetMinimum(0.3938841);
   Graph_Graph_Graph_Graph3100410101016->SetMaximum(1.046696);
